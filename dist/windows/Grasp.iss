...
DefaultDirName={commonpf}/Grasp
DefaultGroupName=Grasp
Compression=none
;Compression=lzma2
;SolidCompression=yes
OutputBaseFilename=Grasp-1.3.1_setup
OutputDir=.
...
Source: "Z:\Qt\rfsm-light\examples\*"; DestDir: "{code:GetDirs|0}\GraspExamples"; Flags: recursesubdirs
 
[Icons]
Name: "{group}\Grasp"; Filename: "{app}\Grasp.exe";IconFilename: "Z:\Qt\rfsm-light\dist\windows\icons\rfsm.ico"
Name: "{group}\{cm:UninstallProgram,Grasp}"; Filename: "{uninstallexe}";IconFilename: "Z:\Qt\rfsm-light\dist\windows\icons\rfsmun.ico"
Name: "{commondesktop}\Grasp"; Filename: "{app}\Grasp.exe";    IconFilename: "Z:\Qt\rfsm-light\dist\windows\icons\rfsm.ico"
...
Filename: "{app}\rfsm-light.ini"; Section: "Settings"; Key: "INITDIR"; String: "{code:GetDirs|0}\GraspExamples"
